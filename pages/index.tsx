	...
	return (
		<>
			<Head>
				...
				<meta name="twitter:site" content="@KrishnLok" />
			...
			<Layout.DarkSection darkSectionRef={darkSectionRef} bannerHeight={bannerHeight}>
				<div className={styles.content}>
					...
					<div className={styles.excellenceWrapper} id="Creativity">
						<Creativity containerRef={containerRef} containerWidth={containerWidth} />
					</div>
					<div id="skills">
						<Skills
